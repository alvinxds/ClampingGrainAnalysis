function [img_rotated] = rotateImageBasedOnMarkerPositions(img, marker_stats)
    ...
    [marker_pos_top_left_rotated, ~, marker_pos_bottom_left_rotated] = rotateTriangleAroundFirstVertex(marker_pos_top_left, marker_pos_top_right, marker_pos_bottom_left, angle);
