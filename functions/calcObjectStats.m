function [object_stats_export] = calcObjectStats(stats_clean, calibfactor_clean, calibfactor_material)
    ...
    for i = 1:n_objects        
        ...
        % Clean Area [mm^2]
        object_stats_export(i).CleanArea_mm2 = stats_clean(i).Area .* calibfactor_clean.^2;
        ...
        % covered_area_px = clean_area_px - free_area_materialimg_px;
        object_stats_export(i).FreeAreaMaterial_mm2 = stats_clean(i).AreaMaterialImage .* calibfactor_material.^2;
        
        % Covered Area [mm^2]
        object_stats_export(i).CoveredArea_mm2 = object_stats_export(i).CleanArea_mm2 - object_stats_export(i).FreeAreaMaterial_mm2;
        
        % Relative Coverage [-]
        object_stats_export(i).RelativeCoverage = object_stats_export(i).CoveredArea_px ./ object_stats_export(i).CleanArea_mm2;        
    end    
end
